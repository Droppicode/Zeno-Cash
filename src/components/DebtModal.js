...
const getStyles = (theme) => {
  ...
  return StyleSheet.create({
    ...
    typeContainer: { flexDirection: 'row', backgroundColor: theme.background, borderRadius: 6 * z, padding: 4 * z, marginBottom: 24 * z },
    typeButton: { flex: 1, paddingVertical: 12 * z, alignItems: 'center', borderRadius: 4 * z },
    ...
    accountBtn: { backgroundColor: theme.background, paddingHorizontal: 16 * z, paddingVertical: 10 * z, borderRadius: 6 * z, marginRight: 8 * z },
    ...
    saveButton: { flex: 1, backgroundColor: theme.accent, paddingVertical: 16 * z, borderRadius: 6 * z, alignItems: 'center' },
    saveButtonText: { color: '#121212', fontSize: 16 * z, fontWeight: 'bold', fontFamily: f },
    deleteButton: { flex: 1, backgroundColor: theme.expense + '15', paddingVertical: 16 * z, borderRadius: 6 * z, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
